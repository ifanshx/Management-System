...
<style>
    ...
    .title-text p { display: flex; align-items: center; gap: 10px; font-size: 14px; color: var(--text-muted); font-weight: 600; margin: 0; letter-spacing: -0.2px;}
    ...
    .header-toolbar { display: flex; align-items: center; background: var(--bg-surface); padding: 12px 20px; border-radius: 16px; border: 1px solid var(--border-subtle); box-shadow: 0 10px 30px -10px rgba(0,0,0,0.05); gap: 12px;}
    .header-toolbar i { color: #0ea5e9; font-size: 22px; }
    ...
    @media (max-width: 1200px) { .bento-row-1 { grid-template-columns: repeat(2, 1fr); } .bento-row-2 { grid-template-columns: 1fr; } }
    @media (max-width: 768px) { .bento-row-1, .bento-row-3 { grid-template-columns: 1fr; } .page-title p { flex-direction: column; align-items: flex-start; gap: 6px; } }
    ...
    .kpi-val { font-size: 34px; font-weight: 900; color: var(--text-main); font-family: 'Space Mono', monospace; margin-top: 10px; letter-spacing: -2px; line-height: 1;}
    
    .kpi-exact { font-size: 12px; font-weight: 800; color: var(--text-muted); font-family: 'Space Mono', monospace; margin-top: 12px; display: inline-flex; align-items: center; gap: 6px; background: var(--bg-base); padding: 6px 12px; border-radius: 8px; border: 1px solid transparent; transition: 0.3s;}
    ...
    /* =========================================================
       ...
       ========================================================= */
    .bento-card { background: var(--bg-surface); border: 1px solid var(--border-subtle); border-radius: 28px; padding: 35px; box-shadow: 0 10px 40px -15px rgba(0,0,0,0.05);}
    .card-title-main { font-size: 18px; font-weight: 900; color: var(--text-main); margin-bottom: 25px; display: flex; align-items: center; gap: 12px; border-bottom: 2px dashed var(--border-subtle); padding-bottom: 18px;}
    ...
    .status-item { display: flex; justify-content: space-between; align-items: center; padding: 20px; background: var(--bg-base); border-radius: 20px; border: 1px solid transparent; transition: all 0.3s cubic-bezier(0.16, 1, 0.3, 1);}
    .status-item:hover { background: var(--bg-surface); border-color: var(--border-subtle); transform: translateX(6px); box-shadow: 0 10px 20px -5px rgba(0,0,0,0.05);}
    
    .status-left { display: flex; align-items: center; gap: 15px;}
    .status-icon { width: 42px; height: 42px; border-radius: 12px; display: flex; align-items: center; justify-content: center; font-size: 20px; background: var(--bg-surface); border: 1px solid var(--border-subtle); color: var(--text-muted); box-shadow: 0 2px 5px rgba(0,0,0,0.02);}
    ...
    .status-val { font-size: 16px; font-weight: 900; font-family: 'Space Mono', monospace; color: var(--text-main); background: var(--bg-surface); padding: 8px 16px; border-radius: 12px; border: 1px solid var(--border-subtle);}
    ...
    /* =========================================================
       6. ATTENDANCE FEED (ABSENSI HARI INI)
       ========================================================= */
    .att-grid { display: grid; grid-template-columns: repeat(auto-fill, minmax(300px, 1fr)); gap: 16px; margin-top: 10px;}
    .att-card { display: flex; justify-content: space-between; align-items: center; background: var(--bg-base); padding: 18px; border-radius: 16px; border: 1px solid var(--border-subtle); transition: var(--transition-smooth);}
    ...
    .att-avatar { width: 42px; height: 42px; border-radius: 12px; background: linear-gradient(135deg, #10b981, #059669); color: #fff; display: flex; align-items: center; justify-content: center; font-size: 16px; font-weight: 900; box-shadow: 0 4px 10px rgba(16, 185, 129, 0.3);}
    ...
    .att-badges { display: flex; flex-direction: column; gap: 6px; align-items: flex-end;}
    .badge-time { font-family: 'Space Mono', monospace; font-size: 11px; font-weight: 800; padding: 4px 10px; border-radius: 8px; display: inline-flex; align-items: center; gap: 6px; border: 1px dashed;}
...
<div class="page-wrapper">
        ...
        <div class="page-title">
            ...
            <div class="title-text">
                ...
                <p>
                    ...
                    Analitik <i style="color: var(--text-main); font-weight: 800; margin: 0 4px;">real-time</i> operasional, manufaktur, dan absensi.
                </p>
            </div>
        </div>
    ...
    <div class="bento-row-2">
        <div class="bento-card" style="padding-bottom: 20px;">
            <div class="card-title-main" style="border-bottom: none; padding-bottom: 0;">
                ...
                <div style="flex: 1;">
                    <div style="font-size: 18px; margin-bottom: 2px;">Tren Arus Kas 6 Bulan Terakhir</div>
                    <div style="font-size: 12px; color: var(--text-muted); font-weight: 600;">Data diekstraksi dari rekam jejak Jurnal Umum</div>
                </div>
            </div>
            <div style="height: 340px; width: 100%; margin-top: 15px; position: relative;">
    ...
    <div class="bento-row-3">
        <div class="bento-card">
            <div class="card-title-main" style="border-bottom: 2px dashed var(--border-subtle); padding-bottom: 15px;">
        ...
        <div class="bento-card">
            ...
            <div class="status-list">
                <div class="status-item">
                    ...
                    <div class="status-val" style="font-size: 14px;">Rp <?= format_compact($sales['b2b_revenue']) ?></div>
                </div>
                <div class="status-item">
                    <div class="status-left">
        ...
        <div class="bento-card">
            ...
            <div class="status-list">
                <div class="status-item">
                    ...
                    <div class="status-val" style="color: #ef4444; font-size: 14px;">Rp <?= format_compact($totalPayrollCost) ?></div>
                </div>
                <div class="status-item">
                    <div class="status-left">
    ...
    <div class="bento-row-4">
        <div class="bento-card" style="padding-top: 25px;">
            <div class="card-title-main" style="justify-content: space-between; border-bottom: 2px dashed var(--border-subtle); padding-bottom: 20px; margin-bottom: 10px;">
                <div style="display: flex; align-items: center; gap: 12px;">
                    <i class="ph-fill ph-fingerprint" style="color: #10b981; background: rgba(16, 185, 129, 0.1); padding: 8px; border-radius: 12px; font-size: 24px; border: 1px solid rgba(16, 185, 129, 0.2);"></i>
                    <div style="display: flex; flex-direction: column;">
                        <span style="font-size: 18px;">Aktivitas Karyawan Terbaru</span>
                        <span style="font-size: 12px; color: var(--text-muted); font-weight: 600;">Log absensi pada hari ini</span>
                    </div>
                </div>
                <div style="font-size: 11px; background: rgba(16, 185, 129, 0.1); color: #10b981; padding: 6px 16px; border-radius: 100px; font-weight: 800; border: 1px solid rgba(16, 185, 129, 0.3);">
                    <?= date('d M Y') ?>
                </div>
            </div>
            ...
            <div class="att-grid">
                <?php if(empty($recentAttendance)): ?>
                    <div style="grid-column: 1 / -1; text-align: center; padding: 40px; color: var(--text-muted); background: var(--bg-base); border-radius: 16px; border: 1px dashed var(--border-subtle);">
                        <i class="ph-duotone ph-fingerprint" style="font-size: 48px; opacity: 0.5; margin-bottom: 10px;"></i>
                        <div style="font-weight: 800; font-size: 14px;">Belum ada karyawan yang absen hari ini.</div>
                    </div>
                <?php else: ?>
                                ...
                                <div style="position: relative; width: 42px; height: 42px;">
                                    <?php if(!empty($att['photo_url']) && $att['photo_url'] !== 'null'): ?>
                                        <img src="<?= esc($att['photo_url']) ?>" alt="Foto" 
                                             style="width: 100%; height: 100%; border-radius: 12px; object-fit: cover; border: 1px solid rgba(16, 185, 129, 0.3); box-shadow: 0 4px 10px rgba(16, 185, 129, 0.3);"
            ...
            <div style="text-align: center; margin-top: 20px;">
                <a href="<?= base_url('/attendance') ?>" style="font-size: 13px; font-weight: 800; color: #0ea5e9; text-decoration: none; padding: 10px 20px; background: rgba(14, 165, 233, 0.05); border-radius: 100px; transition: 0.3s; display: inline-block;">Lihat Semua Log Absensi &rarr;</a>
            </div>
        </div>
    </div>
</div>
