            ...
            <div class="section-box">
                ...
                <div class="row-group">
                    ...
                    <div class="row">
                        <span>
                            Uang Makan Lembur
                            <span class="font-small" style="color: #ef4444;">*(Telah Dibayarkan Tunai Harian)</span>
                        </span> 
                        <span class="font-mono" style="color: #64748b;">Rp <?= number_format($slip['overtime_meal_allowance'], 0, ',', '.') ?></span>
                    </div>
                    <?php endif; ?>
                </div>
                    ...
                    <div class="row">
                        <span>
                            ...
                            <?php if($totalKasbonCombined > 0): ?>
                                <span class="font-small">(Pabrik/Lembur: Rp <?= number_format($cashAdvance,0,',','.') ?> | Makan: Rp <?= number_format($mealDeduction,0,',','.') ?>)</span>
                            <?php endif; ?>
                        </span> 
