...
<body>
    ...
    <div class="action-bar no-print">
        <button onclick="window.print()" class="btn-print">
            <i class="ph-bold ph-file-dashed"></i> Cetak Form Kosong Universal
        </button>
        <br>
        <div class="print-guide">
            <strong>Panduan Cetak:</strong><br>
            1. Anda dapat mencetak form ini sebanyak yang Anda butuhkan (atur <i>Copies</i> di setelan printer).<br>
            2. Centang <b>"Background graphics"</b> agar watermark/garis tercetak.<br>
            3. Kertas ini ditujukan untuk ditulis tangan dari nol oleh Kepala Produksi.
        </div>
    </div>
        ...
        <div class="a4-wrapper">
            ...
            <div class="content-wrapper">
                ...
                <div class="footer-note">
                    <span>Form No: MFG-BLANK-BOM-002</span>
